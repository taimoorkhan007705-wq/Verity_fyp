...
export const getPendingReviews = async (req, res) => {
  try {
    ...
    // Get pending posts, excluding posts created by this reviewer
    ...
    // Convert to array and sort by total posts (prioritize users with more pending posts)
...
export const submitReview = async (req, res) => {
  try {
    ...
    // Prevent reviewers from reviewing their own posts
...
export const getReviewerStats = async (req, res) => {
  try {
    ...
    // Count pending reviews excluding reviewer's own posts
